...
values ('Sandwich', 99.00, 'Yes', '2017-03-15', 'Main Course', 'Yes', 01),
       ('Burger', 129.00, 'Yes', '2017-12-23', 'Main Course', 'No', 02),
       ('Pizza', 149.00, 'Yes', '2017-08-21', 'Main Course', 'No', 03),
       ('French Fries', 57.00, 'No', '2017-07-02', 'Starters', 'No', 04),
...
select m.item_name, m.free_delivery, m.price
from menu_item as m
         inner join cart as c on c.cart_id = m.item_id
         inner join users as u on c.user_id = u.user_id
where u.user_id = 4260;
